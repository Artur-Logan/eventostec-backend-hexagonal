...
public class EventRepositoryImpl implements EventRepository {
    ...
    public Event save(Event event) {
        ...
        return new Event(jpaEventEntity.getId(), jpaEventEntity.getTitle(), jpaEventEntity.getDescription(), jpaEventEntity.getImgUrl(), jpaEventEntity.getEventUrl(), jpaEventEntity.getRemote(), jpaEventEntity.getDate());
    }

    @Override
    public Event findById(UUID id) {
        Optional<JpaEventEntity> jpaEventEntity = this.jpaEventRepository.findById(id);
        return jpaEventEntity.map(entity -> new Event(entity.getId(), entity.getTitle(), entity.getDescription(), entity.getImgUrl(), entity.getEventUrl(), entity.getRemote(), entity.getDate())).orElse(null);
    }
